...
\documentclass[man, floatsintext, 12pt, a4paper, noextraspace]{apa6}
...
\setlength{\skip\footins}{1.5pc plus 0.5pt} % some more space between footnote and main body
% this command put all footnotes to endnote at the end of the paper
%\usepackage{endnotes}
%\let\footnote\endnote

\DeclareCaptionLabelFormat{tablelabel}{\raggedright#1 #2}
\DeclareCaptionLabelFormat{figurelabel}{\raggedright\textit{#1 #2}}
\DeclareCaptionTextFormat{tabletext}{\raggedright\textit{#1}}
...
\note{
    \addvspace{.25in} 
    Word count: 8716 words \\
    Draft date: \today \\
    \addvspace{1in} 
      \textbf{Paper submitted to the Inaugural issue of Computational Communication Research} \\
      Please direct any questions and inquiries to: \href{mailto:hyunjin.song@univie.ac.at}{hyunjin.song@univie.ac.at} \\
      \addvspace{1.25in} 
      A set of replication codes for this manuscript can be found at: \href{http://github.com/revelunt/CCR-When-does-garbage-stink}{http://github.com/revelunt/CCR-When-does-garbage-stink} \\
      }
