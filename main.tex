...
\centerline{ -- Figure \ref{fig:Figure2} about here -- }    

% Figure 2 proportion of decision error
\begin{figure}
         \captionsetup[figure]{labelfont=bf,textfont=normalfont,singlelinecheck=on}
         \centering
         \includegraphics[page=1, trim={0cm 0cm 0cm 0cm}, clip, width=1.05\columnwidth]{Results/BAYES_summary_05.pdf} 
         \captionsetup{format=hang}
         \caption{Proportion of cases (each simulation run) incorrectly conclude on classification performances.} 
         \label{fig:Figure2}
\end{figure}    
