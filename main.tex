...
\begin{figure}
         ...
         \caption{Overall classification accuracy against true value across conditions (Rrference line is overall mean).} 
         \label{fig:Figure1}
\end{figure}    
